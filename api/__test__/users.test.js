...
describe('UnitTests: Users API Route', () => {

    describe('GET /Users', () => {
        it('should return a statement', (done) => {
            request(app)
            .get('/api/v1/users/')
            .expect(200)
            .expect('Content-Type', /text/)
            .expect('users api route: Authentication Logic', done)
        });
    });
    ...
    describe('POST /register', () => {
        ...
        it('should successfully post data to db', async () => {
            ...
            .then( response => {
                ...
                expect(response.body.user.email).toBe(data.email); // should fail if duplicated
